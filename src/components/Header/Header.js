...
const Header = () => {
    return (
        <div>
    <Navbar bg="info" variant="dark" className="p-3">
    <Container>
    <Navbar.Brand className="fw-bold"> <NavLink to="/home" className="text-light text-decoration-none">EducationsCenter</NavLink></Navbar.Brand>
